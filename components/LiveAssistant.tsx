...
const LiveAssistant: React.FC = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[400px] glass rounded-3xl p-10 shadow-2xl border-2 border-emerald-100 animate-in fade-in zoom-in duration-500">
